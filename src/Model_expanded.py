...
class Model:
    ...
    def setupCNN(self, cnnIn3d):
        ...
        # Sixth Layer: Conv (3x3) - Output size: 200 x 16 x 256
        ...
        # Seventh Layer: Conv (3x3) - Output size: 200 x 16 x 256
        ...
        # Eigth Layer: Conv (3x3) - Output size: 200 x 16 x 256
        ...
        # Ninth Layer: Conv (3x3) - Output size: 200 x 16 x 256
        ...
        # Tenth Layer: Conv (3x3) - Output size: 200 x 16 x 256
        ...
        # Eleventh Layer: Conv (3x3) + Simple Batch Norm - Output size: 200 x 16 x 512
        with tf.name_scope('Conv_BN_11'):
            kernel = tf.Variable(tf.truncated_normal(
        ...
        # Twelveth Layer: Conv (3x3) + Pool (2x2) - Output size: 100 x 8 x 512
        with tf.name_scope('Conv_Pool_12'):
            kernel = tf.Variable(tf.truncated_normal(
